          ...
          <div className="space-y-6">
            ...
            {connectionInfo.state === 'error' && (
              <div className="text-center py-8">
                ...
                <p className="text-danger-400 mb-2">{connectionInfo.error}</p>
                <p className="text-slate-500 text-sm mb-6">The connection was lost or failed to establish.</p>
            ...
            {connectionInfo.state === 'disconnected' && (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-slate-200 mb-2">Session Ended</h3>
                <p className="text-slate-500 text-sm mb-6">The sender has disconnected or the session expired.</p>
                <Button onClick={() => window.location.reload()} variant="primary">
                  Start New Session
                </Button>
              </div>
